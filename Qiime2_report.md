...
Shannon index is a measure of entropy, that is, the measure of the amount of information in a system where the unit is bits of information if the logarithms are base 2.
